...
+ um script deveria ler ou criar objetos no início e salvar resultados no final (tabelas `.csv`, figuras ou objetos individuais de `R`)
...
dim(), ncol(), nrow(), selecionar colunas e filtrar linhas. Também com cláusulas lógicas afinal.
