...
+ __interdisciplinar e modular__: muitos especialistas escrevem pacotes 
...
+ descompacte o arquivo .zip, entre na pasta e clique no arquivo __instituto_hub_demo.Rproj__
...
+ Em R sempre primeiro linhas, depois colunas
...
.tiny[
```{r fig.align='center'}
barplot(acu.or[, 2], names.arg = acu.or[, 1])
```
]
